...
class Producto {
    ...
    public static function create($link, $nombre, $descripcion, $precio, $estado){
        ...
        $sql = "INSERT INTO productos (Nombre, Descripcion, Precio, estado) 
                VALUES ('$nombre','$descripcion','$precio','$estado')";
        return mysqli_query($link, $sql);
    }

    public static function update($link, $id, $nombre, $descripcion, $precio, $estado){
